...
@interface ExpandTableViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    ...
    NSMutableArray      *dataSource; // 装有区头对应的数据
    NSMutableArray      *sectionArray; // 区头数据
    NSMutableArray      *stateArray; // 区头关闭展开记录值 0 代表关闭 1 代表打开
}
@end
...
//     展开或者关闭
    ...
    [tlabel setBackgroundColor:[UIColor redColor]];
